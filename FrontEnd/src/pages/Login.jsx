        ...
        <div ref={containerRef} className="min-h-screen flex items-center justify-center bg-white text-foreground p-6 selection:bg-primary/20">
            ...
            <div className="relative z-10 w-full max-w-lg">
                <div className="text-center mb-10">
                    <div className="w-16 h-16 bg-primary rounded-2xl mx-auto flex items-center justify-center shadow-2xl shadow-primary/20 mb-6 rotate-3">
                        <span className="text-white font-bold text-3xl">L</span>
                    </div>
                    <h1 className="text-4xl font-black tracking-tight mb-3">Sign in to Loop</h1>
                    <p className="text-muted-foreground text-lg">Your productivity, simplified.</p>
                </div>
                ...
                >
                    ...
                    <div className="pt-4 text-center">
                        <p className="text-muted-foreground font-medium">
                            First time here? {' '}
                            <Link to="/register" className="text-primary hover:underline font-bold transition-colors">Create Account</Link>
                        </p>
                    </div>
                </form>
            </div>
